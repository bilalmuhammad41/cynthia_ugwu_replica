      ...
      <div className='text-white '>
        ...
        <div className='flex flex-col md:pl-12 sm:pl-10 ss:pl-6 xs:pl-5 '>
          ...
          <div className='flex flex-col w-min items-end'>
            <div className='flex-col text-[#a0a1a3] md:text-[150px] sm:text-[100px] ss:text-[90px] xs:text-[60px] text-container'>
              <span className='hero-text flex items-center font-semibold md:h-[130px] sm:h-[90px] ss:h-[80px] xs:h-[55px]  overflow-hidden '><h1 className='not-visible to-transition'>WEB</h1></span>
